              ...
              <div className="flex flex-wrap gap-4">
                  ...
                  <HoverCardContent className="w-80">
                    <div className="flex gap-4">
                      <Avatar className="h-12 w-12">
                        <img src="/avatar-john.png" alt="John Doe" className="object-cover" />
                        <AvatarFallback>JD</AvatarFallback>
                      </Avatar>
                      <div className="space-y-1">
                        <h4 className="text-sm font-semibold">John Doe</h4>
                        <p className="text-sm text-muted-foreground">
                          Full-stack developer. Building amazing web experiences with React &
                          Next.js.
                        </p>
                ...
                <HoverCard>
                  ...
                  <HoverCardContent className="w-80">
                    <div className="flex gap-4">
                      <Avatar className="h-12 w-12">
                        <img src="/avatar-sarah.png" alt="Sarah Design" className="object-cover" />
                        <AvatarFallback>SD</AvatarFallback>
                      </Avatar>
                      <div className="space-y-1">
                        <h4 className="text-sm font-semibold">Sarah Design</h4>
                        <p className="text-sm text-muted-foreground">
                          UI/UX Designer passionate about creating beautiful and accessible
                          interfaces.
                        </p>
                        <div className="flex items-center gap-2 pt-1">
